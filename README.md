...
1. Download the latest `.apk` from the [Releases](https://github.com/AICrox2025/Infinity-mobile/releases) section.
2. Enable "Install from Unknown Sources" in your Android settings.
3. Install and start surfing with a new vibe!

---

## 📜 License

Distributed under the Mozzila public License. See `LICENSE` for more information.

---

**Developed with ❤️ by AICrox2025**
